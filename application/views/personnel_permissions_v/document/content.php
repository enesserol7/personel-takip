            ...
            <div class="widget has-shadow">
                ...
                <div class="widget-body">
                    <form class="needs-validation" novalidate>
                        ...
                        <div class="form-group row d-flex align-items-center mb-5 col-md-12">
                            <label class="col-lg-2 form-control-label d-flex justify-content-lg-end">İzne ait Evrak </label>
                        ...
                        <div class="text-right">
                            <a href="<?php echo base_url("personnel_permissions/permission_document_confirmation/$item->id/1"); ?>" class="btn btn-shadow btn btn-gradient-04">Rapor İşlendi</a>
                            <a href="<?php echo base_url("personnel_permissions/permission_document_confirmation/$item->id/0"); ?>" class="btn btn-shadow btn btn-gradient-01">Rapor İşlenmedi</a>
                            <a href="<?php echo base_url("personnel_permissions"); ?>" class="btn btn-shadow">Geri Dön</a>
                        </div>
                    </form>
                </div>
            </div>
