<div class="widget widget-07 has-shadow">
	...
	<div class="col-lg-9 pull-right">
		<form class="needs-validation " novalidate action="<?php echo base_url("personnel_payments/salary_accrual_personnel_date"); ?>" method="post">
			<div class="form-group row d-flex align-items-center mb-5">
				...
				<div class="col-lg-3">
					...
					<input type="hidden" class="form-control" name="personnel_id" value="<?php echo $personnel_id; ?>">
